...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s rocketcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rocketcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rocketcoin transaction") + "\n" +
              "  rocketcoin-tx [options] -create [commands]   " + _("Create hex-encoded rocketcoin transaction") + "\n" +
              "\n";
