...
* Update manpages, see [gen-manpages.sh](https://github.com/rocketcoin-project/rocketcoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
- Detached signatures will then be committed to the [rocketcoin-detached-sigs](https://github.com/rocketcoin-project/rocketcoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the rocketcoin.info server.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/rocketcoin-project/rocketcoin/releases/new) with a link to the archived release notes.
